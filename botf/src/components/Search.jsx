...
function Search() {
  const [isFilterPopupOpen, setIsFilterPopupOpen] = useState(false); // Filter modal state
  ...
  return (
    ...
    <div className="bg-white p-6 rounded-lg shadow mb-6">
      <h2 className="text-3xl font-bold mb-4">Search Properties</h2>
      <input
        type="text"
        value={searchTerm}
    ...
    <button
      ...
      className="w-full bg-blue-500 text-white p-4 rounded-lg shadow hover:bg-blue-600 transition"
    >
      Open Filters
    </button>
    ...
    <div className="bg-white w-full max-w-md p-4 rounded-lg shadow-lg max-h-screen overflow-y-auto">
      ...
      <div className="mb-3">
        ...
        <div className="grid grid-cols-3 gap-2">
          {["Studio", "1", "2+1", "3+1", "4+1+", "Private House"].map((option) => (
            <label
              key={option}
